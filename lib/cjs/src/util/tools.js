...
exports.getResolvedColorPair = exports.getBaseColorPair = exports.useThemedColor = exports.getThemedColor = void 0;
 ...
 */
const getThemedColor = (mode) => (color) => {
...
function useThemedColor() {
    ...
    return (0, exports.getThemedColor)(mode);
}
exports.useThemedColor = useThemedColor;
/**
 ...
 */
const getBaseColorPair = (color, theme) => {
...
exports.getBaseColorPair = getBaseColorPair;
/**
 ...
 */
const getResolvedColorPair = (color, theme) => {
    const [base, index] = color.split(".");
    const [isDark, isA] = [base.includes("Dark"), base.includes("A")];
    // search for the base, ex: "blue" from color "blueDarkA"
    // we can search for contiguous lowercase to find this
...
exports.getResolvedColorPair = getResolvedColorPair;
